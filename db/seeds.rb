...
q2 = Question.create(:name => "going_to", :text => "We are going to", :possible_responses => [
...
q3 = Question.create(:name => "gonna_do", :text => "We want to do", :possible_responses => [
...
q4 = Question.create(:name => "going_by", :text => "We intend to travel by", :possible_responses => [
...
q5 = Question.create(:name => "bring_back", :text => "We intend to bring back", :possible_responses => [
...
q6 = Question.create(:name => "like_to_avoid", :text => "We'd like to avoid", :possible_responses => [
...
q7 = Question.create(:name => "cant_do_without", :text => "We can't do without", :possible_responses => [
